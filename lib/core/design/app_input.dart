...
class AppInput extends StatefulWidget {
  ...
  const AppInput({super.key, this.hintText, this.prefixIcon,  this.isPassword=false,  this.bottomSpace= 28, this.controller, this.validator, this.bgColor, this.labelText, this.keyboardType });
    ...
    return  Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          fillColor: widget.bgColor??Color(0xffF2F2F2),
          filled: true,
